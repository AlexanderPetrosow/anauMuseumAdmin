...
@section('title',__('words.add-tariff-pg'))
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">{{__('words.tariffs')}}/</span> {{__('words.add-tariff')}}
</h4>
...
<div class="row">
  <div class="col-md-6">
    <div class="card mb-4">
      ...
      <hr class="my-0">
      <div class="card-body">
        <form id="formAccountSettings" action="/{{$lang}}/admin/add-tariff" method="POST">
          @csrf
          <div class="row">
          ...
          <div class="mb-1 col-lg-12 col-md-6">              
            ...
            <div class="mb-3 col-lg-12 col-md-6">              
              ...
              <div class="input-group mt-1 dnone" id="currency2">
                ...
                <!-- <span class="input-group-btn">
                  <button type="button" id="addCurrency2" class="btn-icon bordered-btn fs-2">
              ...
              <div class="input-group mt-1 dnone" id="currency3">
                ...
                <!-- <span class="input-group-btn">
                  <button type="button" id="addCurrency3" class="btn-icon bordered-btn fs-2">
                    <span style="transform: rotate(45deg);">+</span>
                  </button>
                </span> -->
              </div>
            ...
            <div class="mb-3 col-lg-12 col-md-6">
              ...
              <input type="text" name="comment" class="form-control" id="organization" name="organization" />
            </div>
            <div class="mb-3 col-lg-12 col-md-6">
              <label class="form-label" for="phoneNumber">{{__('words.sorting')}}</label>
              <div class="input-group input-group-merge">
                <!-- <span class="input-group-text">US (+1)</span> -->
                <input type="text" id="Number" name="sort" class="form-control" placeholder="0" value="0" />
              </div>
            ...
            <label class="mb-3 px-3 col-12">
              <input class="form-check-input me-1" name="promo" type="checkbox" placeholder="">
              {{__('words.sale')}}
            </label>
          <div class="mt-2">
