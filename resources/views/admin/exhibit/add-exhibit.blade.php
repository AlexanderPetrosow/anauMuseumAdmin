...
@extends('layouts/contentNavbarLayout') @section('title', __('words.add-exhibit-pg')) @section('page-script')
<script src="{{asset('assets/js/pages-account-settings-account.js')}}"></script>
@endsection @section('content')
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">{{__('words.exhibits')}} / </span> {{__('words.add-exhibit')}}
</h4>
<form action="/{{$lang}}/admin/add-exhibit" method="POST" enctype="multipart/form-data">
  @csrf
<div class="row">
  <div class="col-12">
      ...
      {{-- tm-card-info --}}
        <div class="card-body info-cards" id="tm-card">
          <div class="row">
            ...
            <div class="mb-3 col-md-12">
              ...
              <textarea class="form-control" id="exampleFormControlTextarea1" name="tm_description" rows="3" placeholder="{{__('words.comments')}}"></textarea>
        ...
        <div class="card-body info-cards dnone" id="ru-card">
          <div class="row">
            ...
            <div class="mb-3 col-md-12">
              <label for="lastName" class="form-label">{{__('words.comments')}}</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" name="ru_description" rows="3" placeholder="{{__('words.comments')}}"></textarea>
        ...
        <div class="card-body info-cards dnone" id="eng-card">
          <div class="row">
            ...
            <div class="mb-3 col-md-12">
              <label for="lastName" class="form-label">{{__('words.comments')}}</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" name="eng_description" rows="3" placeholder="{{__('words.comments')}}"></textarea>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
          <div class="row">
            ...
            <div class="mb-3 col-md-12">
              <label for="Hall" class="form-label">{{__('words.exposure')}}</label>
              <select id="hall" name="exposure" class="select2 form-select">
                <option value="">{{__('words.select-exposure')}}</option>
                @foreach($exposures as $exposure)
                <option value="{{$exposure['id']}}">{{$exposure[$lang.'_name']}}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="mb-3 col-md-12">
              ...
              <input class="form-control" type="text" id="sort" name="sort" placeholder="0" value="0" autofocus/>
